...
class Grey: public AbsorptionModel
{
    private:
        int NBands = 1;
    ...
    public:
        ...
        double kappa(int iBand, double pH2O, double pCO2){return 0.;};
        double kappa(double T, double pH2O, double pCO2);
